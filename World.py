...
from typing import Tuple, List, Dict  # etc.
...
class World():
    ...
    #				ACTIONS ON BOARD 			  #
    ###############################################
    def __checkValidAction(self, actionObj: Action) -> bool:
    ...
    def __doMove(self, actionObj: Action) -> bool:
    ...
    #####################################################
    def __createBoard(self, inputStream: TextIO = None) -> None:
        """ Creates 2D tile array from f irst line of file and instantiates board instance variable """
        if inputStream:
    ...
    def __getFirstMove(self, inputStream: TextIO = None) -> Tuple[int, int]: 
    ...
    def __addMines(self, inputStream: TextIO = None) -> None:
